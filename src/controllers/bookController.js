...
const publisherModel = require("../models/PubilsherModel")
...
const createBook = async function(req,res){
    let book = req.body
    let authorId=await authorModel.find().select({_id:1}) //get the list of objects contaning author obj_id one 
    authorIdArr=authorId.map((obj)=>{return obj._id.toString()}) //get the string from object_id is optented 

    
        // Here be checked two input ref ID ObjecID Author ("62a1f206194c63050bb9f00e")]  publisher "62a1f206194c63050bb9f00e"
